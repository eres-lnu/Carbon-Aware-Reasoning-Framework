...
public class Eucloudsoftware {
	...
	private Eucloudsoftware() {
		...
		host = new NamedHost("FrontendServer", 65536, 20000, 5000000, List.of(new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300)), 1250000.0, 1.892E8, 150.0, "eu_central_1");
		hostList.add(host);
		Vm FrontendServerNodeJsPod = new LinkedVm(6300, 16, host.getName()).setRam(16384).setBw(1000).setSize(10000).setDescription("NodeJsPod").setCloudletScheduler(new CloudletSchedulerSpaceShared());
		vmList.add(FrontendServerNodeJsPod);
		host = new NamedHost("ShippingServer", 65536, 20000, 5000000, List.of(new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300)), 1250000.0, 1.892E8, 150.0, "eu_central_1");
		hostList.add(host);
		Vm ShippingServerJavaPod = new LinkedVm(6300, 2, host.getName()).setRam(512).setBw(1000).setSize(10000).setDescription("JavaPod").setCloudletScheduler(new CloudletSchedulerSpaceShared());
		vmList.add(ShippingServerJavaPod);
		host = new NamedHost("OrdersServer", 65536, 20000, 5000000, List.of(new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300)), 1250000.0, 1.892E8, 150.0, "eu_central_1");
		hostList.add(host);
		Vm OrdersServerJavaPod = new LinkedVm(6300, 4, host.getName()).setRam(512).setBw(1000).setSize(10000).setDescription("JavaPod").setCloudletScheduler(new CloudletSchedulerSpaceShared());
		vmList.add(OrdersServerJavaPod);
		Vm OrdersServerMongoDBPod = new LinkedVm(6300, 2, host.getName()).setRam(512).setBw(1000).setSize(10000).setDescription("MongoDBPod").setCloudletScheduler(new CloudletSchedulerSpaceShared());
		vmList.add(OrdersServerMongoDBPod);
		host = new NamedHost("CartsServer", 65536, 20000, 5000000, List.of(new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300)), 1250000.0, 1.892E8, 150.0, "eu_central_1");
		hostList.add(host);
		Vm CartsServerJavaPod = new LinkedVm(6300, 2, host.getName()).setRam(512).setBw(1000).setSize(10000).setDescription("JavaPod").setCloudletScheduler(new CloudletSchedulerSpaceShared());
		vmList.add(CartsServerJavaPod);
		Vm CartsServerMongoDBPod = new LinkedVm(6300, 2, host.getName()).setRam(512).setBw(1000).setSize(10000).setDescription("MongoDBPod").setCloudletScheduler(new CloudletSchedulerSpaceShared());
		vmList.add(CartsServerMongoDBPod);
		host = new NamedHost("CatalogueServer", 65536, 20000, 5000000, List.of(new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300)), 1250000.0, 1.892E8, 150.0, "eu_central_1");
		hostList.add(host);
		Vm CatalogueServerGoPod = new LinkedVm(6300, 2, host.getName()).setRam(512).setBw(1000).setSize(10000).setDescription("GoPod").setCloudletScheduler(new CloudletSchedulerSpaceShared());
		vmList.add(CatalogueServerGoPod);
		Vm CatalogueServerMariaDBPod = new LinkedVm(6300, 2, host.getName()).setRam(512).setBw(1000).setSize(10000).setDescription("MariaDBPod").setCloudletScheduler(new CloudletSchedulerSpaceShared());
		vmList.add(CatalogueServerMariaDBPod);
		host = new NamedHost("PaymentServer", 65536, 20000, 5000000, List.of(new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300)), 1250000.0, 1.892E8, 150.0, "eu_central_1");
		hostList.add(host);
		Vm PaymentServerGoPod = new LinkedVm(6300, 2, host.getName()).setRam(512).setBw(1000).setSize(10000).setDescription("GoPod").setCloudletScheduler(new CloudletSchedulerSpaceShared());
		vmList.add(PaymentServerGoPod);
		host = new NamedHost("QueueMasterServer", 65536, 20000, 5000000, List.of(new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300)), 1250000.0, 1.892E8, 150.0, "eu_central_1");
		hostList.add(host);
		Vm QueueMasterServerJavaPod = new LinkedVm(6300, 2, host.getName()).setRam(512).setBw(1000).setSize(10000).setDescription("JavaPod").setCloudletScheduler(new CloudletSchedulerSpaceShared());
		vmList.add(QueueMasterServerJavaPod);
		host = new NamedHost("RabbitMQServer", 65536, 20000, 5000000, List.of(new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300)), 1250000.0, 1.892E8, 150.0, "eu_central_1");
		hostList.add(host);
		Vm RabbitMQServerRabbitMQPod = new LinkedVm(6300, 2, host.getName()).setRam(512).setBw(1000).setSize(10000).setDescription("RabbitMQPod").setCloudletScheduler(new CloudletSchedulerSpaceShared());
		vmList.add(RabbitMQServerRabbitMQPod);
		host = new NamedHost("UsersServer", 65536, 20000, 5000000, List.of(new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300), new PeSimple(6300)), 1250000.0, 1.892E8, 150.0, "eu_central_1");
		hostList.add(host);
		Vm UsersServerGoPod = new LinkedVm(6300, 2, host.getName()).setRam(8192).setBw(1000).setSize(10000).setDescription("GoPod").setCloudletScheduler(new CloudletSchedulerSpaceShared());
		vmList.add(UsersServerGoPod);
		Vm UsersServerMongoDBPod = new LinkedVm(6300, 2, host.getName()).setRam(8192).setBw(1000).setSize(10000).setDescription("MongoDBPod").setCloudletScheduler(new CloudletSchedulerSpaceShared());
		vmList.add(UsersServerMongoDBPod);
		
		datacenter = new DatacenterSimple(simulation, hostList, new CustomAllocationPolicy(hostList));
		datacenter.setName("Eucloudsoftware");
